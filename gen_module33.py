...
OUTPUT   = "/home/user/Ebook/module33_preview.pdf"
IMG_PATH = "/home/user/Ebook/images/33_rosebreasted_grosbeak.jpg"
...
def page1(c):
    chrome(c,97,"Module 33 of 40")
    content=[Table([[Paragraph("MODULE  33  /  40",sp("m","Helvetica-Bold",8,G_DARK,11))]],colWidths=[CW])]
    ...
    c2=[Paragraph("PRESENTATION",S_HDR),
        Paragraph("The Rose-breasted Grosbeak is one of the most spectacular songbirds "
            "to visit eastern North American feeders — the male's jet-black head and "
            "back, snow-white underparts, and vivid rose-red breast triangle make it "
            "unmistakable and unforgettable. Its large, pale, conical bill is built "
            "for cracking large seeds and fruit pits with ease. It arrives at "
            "feeders each spring as a migrant and breeding visitor, generating "
            "excited reports from birders across the eastern half of the continent. "
            "The female, streaked brown like a large sparrow, is far more cryptic "
            "but equally striking up close — and she sings almost as well as her "
            "mate.",S_BODY),
        Paragraph("HABITAT & RANGE",S_HDR),
        Paragraph("The Rose-breasted Grosbeak breeds in deciduous and mixed forests "
            "across central and eastern Canada and the northeastern United States, "
            "south through the Appalachians and east-central states. It winters in "
            "Central America and northern South America. It is a neotropical "
            "migrant, appearing at feeders across eastern North America in May and "
            "September during migration, when it regularly visits sunflower feeders "
            "during stopovers. It favors mature forest edges, woodland clearings, "
            "and suburban areas with large trees.",S_BODY),
        Paragraph("DIET & FEEDING",S_HDR)]
    for f in ["Black-oil sunflower seeds — the most reliable feeder attractant",
...
def page2(c):
    chrome(c,98,"Rose-breasted Grosbeak")
    content=[Paragraph("BEHAVIOR & SOCIAL LIFE",S_HDR),
        Paragraph("Rose-breasted Grosbeaks are surprisingly docile at feeders for such "
            "a large, boldly marked bird — they often feed quietly alongside other "
            "species, unlike the aggressive Blue Jay or Steller's Jay. Males arrive "
            "on the breeding grounds before females and establish territories through "
            "song rather than aggressive chasing. They are unusual among songbirds "
            "in that the male incubates eggs and broods nestlings almost as much as "
            "the female — and he sings quietly while sitting on the nest. Outside "
            "the breeding season they are loosely gregarious, traveling in small "
            "groups during migration.",S_BODY),
        Paragraph("NESTING & BREEDING",S_HDR),
        Paragraph("Rose-breasted Grosbeaks build a loose, flimsy cup nest of twigs, "
            "grasses, and plant material, typically 5–20 feet high in a deciduous "
            "tree or shrub. Both sexes build the nest and incubate the 3–5 pale "
            "blue-green eggs with brown spots for 13–14 days. Both parents feed "
            "the nestlings, which fledge at 9–12 days. The male is a devoted "
            "parent, singing softly while incubating. Pairs raise one brood per "
            "season. The male's rose breast patch is used in a threat display "
            "against rival males.",S_BODY),
        Paragraph("SONG & COMMUNICATION",S_HDR),
        Paragraph("The Rose-breasted Grosbeak's song is a rich, flowing carol often "
            "compared to an American Robin that has taken singing lessons — cleaner, "
            "faster, and with a more liquid quality. Both sexes sing, and the female "
            "sings a somewhat softer version while incubating. The call is a "
            "distinctive sharp, metallic \"eek\" or \"squeak\" — often described "
            "as sounding like a sneaker on a gym floor — that instantly identifies "
            "the species even when it cannot be seen.",S_BODY),
    ...
    content+=[tbl,Spacer(1,6),
        Paragraph("The Rose-breasted Grosbeak population is estimated at 4.1 million "
            "individuals and has declined by approximately 52% since 1970 — one "
            "of the steeper declines among eastern forest songbirds. Loss of "
            "mature deciduous forest on both breeding and wintering grounds, "
            "window collisions during migration, and free-roaming cats are the "
            "primary threats. Sunflower feeders during spring migration provide "
            "a critical energy source for this long-distance migrant.",S_BODY),
        Paragraph("FEEDER TIPS",S_HDR)]
    for t in ["Black-oil sunflower seeds on a hopper or platform feeder are the top attractant",
...
def page3(c):
    ...
    c.drawCentredString(W/2,H-0.56*inch,"Rose-breasted Grosbeak  •  Pheucticus ludovicianus  •  Module 33")
    FTR_H=0.45*inch
    c.setFillColor(G_DARK); c.rect(0,0,W,FTR_H,fill=1,stroke=0)
    c.setFillColor(GOLD); c.setFont("Helvetica-Bold",7.5)
    c.drawString(ML,0.16*inch,"Backyard Birds of North America  •  Vol. 1")
    c.setFillColor(CREAM); c.setFont("Helvetica",7.5)
    c.drawRightString(W-MR,0.16*inch,"Page 99")
    pad=0.18*inch
